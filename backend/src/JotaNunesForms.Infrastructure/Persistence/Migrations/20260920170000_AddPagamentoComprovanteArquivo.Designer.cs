...
namespace JotaNunesForms.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260920170000_AddPagamentoComprovanteArquivo")]
    partial class AddPagamentoComprovanteArquivo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JotaNunesForms.Domain.Entities.PagamentoFuncionario", b =>
                {
                    ...
                    b.Property<string>("ComprovanteStorageKey")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                        .HasColumnName("comprovante_storage_key");

                    b.Property<long?>("ComprovanteTamanhoBytes")
                        .HasColumnType("bigint")
